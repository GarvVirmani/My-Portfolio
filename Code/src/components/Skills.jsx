...
function Skills() {
  ...
  return (
    <section id="skills" className="min-h-screen bg-[#1e2328] px-6 py-12 flex flex-col items-center relative">
      ...
      <motion.div 
        ...
        className="max-w-4xl mx-auto grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6 z-10"
      >
        {skills.map(({ name, icon }) => (
          <motion.div
            ...
            whileHover={{ 
              scale: 1.1,
              rotate: [0, -5, 0, 5, 0],
              boxShadow: "0 0 15px rgba(255, 92, 92, 0.5)"
            }}
            whileTap={{ scale: 0.95 }}
            className="bg-[#2a2f35] p-4 rounded-lg text-center cursor-pointer hover:bg-[#3a3f45] transition-all"
          >
