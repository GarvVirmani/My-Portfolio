...
function About() {
  ...
  return (
    <motion.section
      ...
      id="about"
      className="min-h-screen flex flex-col items-center justify-center bg-[#1e2328] px-6 text-center font-sans"
    >
      ...
      >
        <motion.h2 
          variants={item}
          className="text-4xl md:text-5xl font-semibold mb-8 tracking-wide text-[#ff5c5c]"
