      ...
      >
        ...
        >
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="px-6 py-3 border-2 border-[#ff5c5c] text-white rounded-lg font-medium bg-transparent hover:bg-[#ff5c5c] transition-all"
          >
            About Me
          </motion.button>
        </Link>
      ...
      {showMouseIcon && (
        ...
        >
          <Link to="about" smooth duration={500}>
            <div className="w-8 h-12 border-2 border-[#ff5c5c] rounded-full flex justify-center p-1">
              <motion.div 
                animate={{ y: [0, 8, 0] }}
                transition={{ repeat: Infinity, duration: 1.5 }}
